/**
 * BrandLogos — the real MTN and Orange Money marks, embedded as official
 * vectors (Wikimedia Commons brand files) so payment and sign-in surfaces
 * show the logos people actually know, not colored dots.
 */
...
/** MTN MoMo: the black MTN mark on its yellow tile. */
...
/** Orange Money: the official orange square with the white wordmark. */
